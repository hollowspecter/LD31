...
public class GUIParallelOneForAll : GUINode 
{
	ParallelOneForAll model;
	
	Vector2 offsetToParent;
	
	public GUIParallelOneForAll(int value, Vector2 position) : base("ParallelOneForAll", value, position)
	{
	...
	public void SetModel(ParallelOneForAll model)
	{
		this.model = model;
		DragUpdate();
		DragEnd ();
